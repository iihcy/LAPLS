...
if __name__ == '__main__':
    x0, y0 = loadDataSet01('TestRB.txt')#单因变量与多因变量
    # 随机划分数据集- (十折交叉验证)
    ...
    #print (xish)
    print ("=============================")
    # file0 = pd.DataFrame(test_x)
    # file0.to_csv('TestWYHXBDataX.csv')
    # file = pd.DataFrame(test_y)
    # file.to_csv('TestWYHXBDataY.csv')