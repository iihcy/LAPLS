...
if __name__ == '__main__':
    x0, y0 = loadDataSet01('CCrime01.txt')#单因变量与多因变量
    # 随机划分数据集- (十折交叉验证)
...
#     print("=============================")
#     print(shape(test_x))
#     file = pd.DataFrame(test_x)
#     file.to_excel('CCrime01.xls')
#     file1 = pd.DataFrame(test_y)
#     file1.to_excel('CCrime02.xls')
