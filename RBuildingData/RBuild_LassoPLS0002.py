...
#Lasso函数
def lasso_regression(X, y, lambd, threshold=0.001):
    '''
...
def lasso_traj(e0, f0, ntest):
    ...
    for i in range(ntest):
        w = lasso_regression(e0, f0, lambd=exp(i-15))
        ws[i, :] = w.T
...
if __name__ == '__main__':
    x0, y0 = loadDataSet01('T-RBuildData.txt')#单因变量与多因变量
    # 随机划分数据集- 7:3
